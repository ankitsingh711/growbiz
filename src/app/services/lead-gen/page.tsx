...
export default function LeadGenServicePage() {
    const service = services.find((s) => s.slug === "lead-gen")!
        ...
        <main className="min-h-screen bg-white">
                ...
                <div className="container relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                            <img src="https://images.unsplash.com/photo-1553877522-43269d4ea984?auto=format&fit=crop&q=80&w=800" alt="Lead Generation" className="rounded-2xl shadow-2xl" />
                        </motion.div>
                    </div>
                </div>
            </section>
            <section className="py-24 container">
                <div className="max-w-3xl mx-auto text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold font-heading mb-4">Lead Generation <span className="text-brand-yellow">Benefits</span></h2>
                </div>
            ...
            <CTA variant="dark" title="Fill Your Sales Pipeline" buttonText="Generate Quality Leads" />
            <Footer />
        </main>
    )
}
